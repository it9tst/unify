...
<span class="title_page_1">Singoli <?php echo $this->Genere[0]["Testo"]; ?></span>
<div class="brani_album_ext">
    <div class="card-deck">
		<?php if(count($this->genreSingoli)<1) echo "Non sono presenti singoli ".$this->Genere[0]["Testo"]." nel sistema. Attendi che ne vengano inseriti.";?>
		<?php foreach($this->genreSingoli as $singolo): ?>
...
<span class="title_page_1">Album <?php echo $this->Genere[0]["Testo"]; ?></span>
<div class="brani_album_ext">
    <div class="card-deck">
		<?php if(count($this->genreAlbum)<1) echo "Non sono presenti album ".$this->Genere[0]["Testo"]." nel sistema. Attendi che ne vengano inseriti.";?>
		<?php foreach($this->genreAlbum as $album): ?>
    	<div class="card card_album">
