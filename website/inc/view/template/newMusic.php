<span class="title_page_1">Gli ultimi singoli usciti</span>
<div class="brani_album_ext new_music_page">
	<div class="card-deck">
		<?php foreach($this->NewSingoli as $singolo): ?>
...
<span class="title_page_1">Gli ultimi album usciti</span>
<div class="brani_album_ext new_music_page">
	<div class="card-deck">
		<?php foreach($this->NewAlbums as $album): ?>
		<div class="card card_album">
...
<span class="title_page_1">Le ultime Playlist create</span>
<div class="playlist_ext new_music_page">
	<div class="card-deck">
		<?php foreach($this->NewPlaylist as $playlist): ?>
